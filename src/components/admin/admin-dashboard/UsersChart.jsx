...
const UsersChart = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-[100vw] overflow-x-hidden md:overflow-x-hidden md:ml-3 md:flex-row
                    md:justify-between md:w-[45vw] lg:w-[36.2vw] lg:ml-2 xl:w-[37vw] xl:ml-3'>
              ...
              <div className='flex flex-row items-center justify-end w-[40vw] mt-2 mr-2 md:w-[0vw] md:ml-7 lg:mr-3'>
                 <select className='bg-[#f7f5f5] rounded outline-none text-[9px] h-5 w-[3rem] pl-1 lg:h-5 xl:w-[3.5rem] xl:text-[12px]'
                  name="date" id="date">
                   ...
                   <hr />
                   <option className='text-[9px]' value="1 week">volume</option>
                   <hr />
                   <option className='text-[9px]' value="1 week">value</option>
                 </select>
              </div>
           </div>
