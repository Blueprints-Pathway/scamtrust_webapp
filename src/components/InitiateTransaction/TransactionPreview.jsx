...
const TransactionPreview = (props) => {
  ...
  return (
    <div className="absolute ml-[25px] w-[85vw] bg-white rounded-[20px] top-1/2 left-1/2 lg:w-[70vw] 2xl:w-[1097px] lg:p-8 p-4 2xl:p-16 -translate-x-1/2 -translate-y-1/2 z-30">
