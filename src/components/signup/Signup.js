                    ...
                    <div className="form signup">
                      {/*   <pre>{
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          {/*   {Object.keys(error).length > 0 && checked ? (
                                <button className='button-primary' type="submit">
                                    Sign Up good
                                        ...
                                        <button className='button-primary' type="submit" disabled>
                                            ...
                                            { (!checked)  ? (<button className='signup-button no' disabled> Proceed to verify BVN </button>) : ((submit && !error.phoneNumber) && (submit && !error.email) && (submit && !error.userName) && (submit && !error.location)) ? (<Link to='/bvn'><button className='signup-button yes'> Proceed to verify BVN </button></Link>) : ((submit && error.phoneNumber) && (submit && error.email) && (submit && error.userName) && (submit && error.location)) ? (<button className='signup-button yes'> Proceed to verify BVN </button>) : (<button className='signup-button yes'> <div null> Proceed to verify BVN </div> </button>) }

                            {/* {((submitted && error.phoneNumber) || (submitted && error.email) || (submitted && error.userName) || (submitted && error.location)) ? (
                                <button className='signup-button no' disabled> Proceed to verify BVN </button>
                                    ) : checked ? (
                                        <Link to='#'><button className='signup-button yes'> Proceed to verify BVN </button></Link>
                                            ) : (
                                                <button className='signup-button no' disabled> Proceed to verify BVN </button>
                                                    )} */}
                           ...
                           {/*  {checked || error.phoneNumber || error.email || error.userName || error.location ? <button className='signup-button no' disabled> Proceed to verify BVN </button> : <button className='signup-button yes'> <div null><Link to='#'> Proceed to verify BVN </Link></div> </button>}

                            {checked && Object.keys(error).length > 0 ? <button className='signup-button yes'> <div null><Link to='#'> Proceed to verify BVN </Link></div> </button> : <button className='signup-button no' disabled> Proceed to verify BVN </button> } */} 
