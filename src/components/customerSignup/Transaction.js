                ...
                <div className='cardContainerTransaction'>
                    ...
                    <div className="form transaction">
                        ...
                        <form autoComplete="off" onSubmit={handleSubmit} >
                            ...
                            {   ((submitted && !error.pinCheckError2) && (submitted && !error.pinCheckError1)) ? ( <Link to='/setPassword'> <button className='Transaction-button yes' type='submit' > Set security question </button> </Link>) : (<button className='Transaction-button yes' type='submit' > Set security question </button>) }


                       {/*      {Input ? <Link to='#'><button className='Transaction-button yes' type='submit' > Set security question </button></Link> : <Link to='#'><button className='Transaction-button no' type='submit' disabled> Set security question </button></Link>}
