...
function CustomerSetPassword() {
    ...
    const validate = (values) => {
        ...
        if (!values.password) {
            ...
            error.password = ' Must contain minimum of 8 characters, 1 uppercase, 1 lowercase, 1 number, 1 special character';
        }
                ...
                <div className='cardContainerPassword'>
                    ...
                    <div className="form password">
                        ...
                        <form>
                            ...
                            {submitted && error.password && <span className='error passShift21'><FontAwesomeIcon className='exIconTrans' icon={faCircleExclamation} />{error.password}</span>}
