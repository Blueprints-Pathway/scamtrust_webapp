...
import { faArrowLeft, faArrowRight, faSearch, faPen, faCircleExclamation, faPlus, faEyeSlash, faEye, faCircleQuestion, faTrashCan } from "@fortawesome/free-solid-svg-icons";
...
function SettingsVendor() {
    ...
    const handleClosed26 = () => {
        setClosed26(!closed26);
    }
    const [closed26, setClosed26] = useState(false);

    const handleClosed27 = () => {
        setClosed27(!closed27);
    }
    const [closed27, setClosed27] = useState(false);
        ...
        <>
            <div className='main'>
                ...
                <div className={checked ? 'header active' : 'header'}>
                    <div className="side-icon" onClick={handleCheckbox}>
                    ...
                    <div className={checked ? "CenterBottom active" : "CenterBottom"}>
                        ...
                        <div className="CenterGeneralSettings">
                            <div className="GeneralSettings">
                                ...
                                <form className={select ? "form-GeneralSettings white-bg" : 'hide'} onSubmit={handleSubmit}>
