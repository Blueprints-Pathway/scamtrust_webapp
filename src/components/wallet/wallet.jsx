		...
		<div className="container-fluid mx-auto ">
			<div className="flex flex-row">
				<div className="inline-flex">
					<SideNav menuActive={menuActive} close={closeNav} />
				</div>
				<div className="grow">
					<WalletNav open={openNav} menuActive={menuActive} />
							...
							<div className="grid grid-cols-1 gap-10">
								<div className="p-5 rounded-lg bg-white border ">
									...
									<div className="py-3">
										...
										>
											<h5 className=" my-2">
												<span style={{ color: "#126A2B" }}>#1,000,345</span>{" "}
												withdrawn so far <br />
								...
								<div className="grid grid-cols-2 gap-5 ">
									<div
										className="p-5  h-44 rounded-lg border"
										style={{
									...
									<div
										className="p-5 rounded-lg h-44  border"
										style={{
