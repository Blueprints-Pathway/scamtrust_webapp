			...
			<div className="main">
				<div className={this.state.click ? "side active" : "side"}>
					...
					<Link to="/Home">
						<div className="side-bar-top">
							<div
								className={
									this.state.click ? "side-bar-title active" : "side-bar-title"
								}
							>
								{" "}
								Scam Trust{" "}
							...
							<img
								className={
									this.state.click ? "side-bar-logo active" : "side-bar-logo"
								}
								src={scamTrust}
								alt="Scam Trust"
							/>
					...
					{sideBarItems.map((item, index) => {
						return (
							<div className="sides mt-5" key={index}>
								<Link
									to={`/${item.link}`}
									className={
										this.state.click ? `${item.cName}` : `${item.cNameX}`
									}
								>
									<div
										className={
											this.state.click ? "side-item active" : "side-item"
										}
									>
										<FontAwesomeIcon icon={item.icon} />
										<h6 className={this.state.click ? "inActive" : "Active"}>
											{item.name}
										</h6>
									</div>
								</Link>
								<Link
									to={`/${item.link2}`}
									className={
										this.state.click ? `${item.cName2}` : `${item.cNameX2}`
									}
								>
									<div
										className={
											this.state.click ? "side-item2 active" : "side-item2"
										}
									>
										<FontAwesomeIcon icon={item.icon2} />
										<p className={this.state.click ? "inActive" : "Active"}>
											{item.name2}
										</p>
									</div>
								</Link>
					...
					<img
						className="side-bar-logo-bottom"
						src={scamSheild}
						alt="Scam Trust"
					/>
				</div>
				...
				<div className={this.state.click ? "header active" : "header"}>
					<div className="side-icon" onClick={this.Click}>
						<FontAwesomeIcon
							icon={this.state.click ? faArrowRight : faArrowLeft}
							className="toggle"
						/>
					</div>
					...
					<div clasName="userAbbrevation-wrap">
						<div className="userAbbrevation enclosed">RV</div>
					</div>
				</div>
				...
				<main>
					<div
						className={
							this.state.click ? "container center active" : "container center"
						}
					>
						<div className="left mt-5">
							<div className="left-top-card mt-5">
								...
								<div className="vendor-name">Hello Ridic Ventures</div>
						...
						<div className="right">
							<div className="right-top-card mt-5" style={{ 
								marginTop:"30px"
							 }}>
								<div className="card2-title">
									...
									<p
										className={
											this.state.click
												? "card2-text-right"
												: "card2-text-right active"
										}
									>
										Ridic Business Ventures
										<h5 className="card2-text-right2">ID - 6057702</h5>
										<div
											className={this.state.click ? "Line" : "Line active"}
										></div>
									</p>
								</div>
								<FontAwesomeIcon
									...
									<div className="Wallet-card-left">
										<div className="Wallet-card-left-top">
											...
											<div
												className={
													this.state.click
														? "Wallet-card-left-top-right active"
														: "Wallet-card-left-top-right"
												}
											>
										...
										<div className="Wallet-card-left-bottom">
											...
											<div className="Wallet-card-left-bottom-right">
												<p
													className={
														this.state.click ? "Withdraw active" : "Withdraw"
													}
												>
													WITHDRAWAL
												</p>
							...
							<div className="right-bottom-card">
								...
								<div className="row">
									...
									<div
										className={
											this.state.click ? "mixed-chart" : "mixed-chart active"
										}
									>
										<Chart
