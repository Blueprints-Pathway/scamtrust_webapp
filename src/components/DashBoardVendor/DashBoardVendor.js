          ...
          <div className='left-bottom-card'>
              <div className="transactions">
                ...
                <div className="category">
                  {select ? (<h6 className="Selection active" onClick={handleSelect}>All</h6>
                  ) : <h6 className="Selection" onClick={handleSelect}>All</h6>}
                  {select2 ? <h6 className="Selection active" onClick={handleSelect2}>Outgoing</h6> : <h6 className="Selection" onClick={handleSelect2}>Outgoing</h6>}
                  {select3 ? <h6 className="Selection active" onClick={handleSelect3}>Cancelled</h6> : <h6 className="Selection" onClick={handleSelect3}>Cancelled</h6>}
                  {select4 ? <h6 className="Selection active" onClick={handleSelect4}>Completed</h6> : <h6 className="Selection" onClick={handleSelect4}>Completed</h6>}
