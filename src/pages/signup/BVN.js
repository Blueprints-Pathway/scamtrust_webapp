                            ...
                            JSON.stringify(values, null, 2)
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="input-field">
                                        ...
                                        <input onChange={handleChange} value={values.DOB} className="inputBoxBVN" name='DOB' placeholder="" type="text" autoComplete='off' />
                                    ...
                                    {   ((submitted && !error.phoneNumber) && (submitted && !error.DOB) && (submitted && !error.BVN) && (submitted && !error.fullName)) ? ( <Link to='/setPassword'> <button className='bvn-button yes' type='submit' > Verify </button> </Link>) : (<button className='bvn-button yes' type='submit' > Verify </button>) }

                                </form>
                                <div className='field-bottom-bvn'> Secured by <img className='field-bottom-img' src={scamTrustLogo} alt="Scam Trust" />  <Link to='/setPassword'><div className='skip-link'>
                                    Skip
                                </div></Link> </div>
