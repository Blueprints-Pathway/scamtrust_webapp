      ...
      <div className="signup-viewmain container">
          ...
          <div className="signup-view-left">
            ...
            <div className="form signup">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {!checked ? (
                  <button className="signup-button no" disabled>
                    {" "}
                  ...
                  !error.location ? (
                  <Link to="/bvn">
                    <button className="signup-button yes">
                      {" "}
                      Proceed to verify BVN{" "}
                    </button>
                  </Link>
                  ...
                  <button className="signup-button yes">
                    {" "}
                    <div null> Proceed to verify BVN </div>{" "}
                  </button>
                )}
        ...
        <div className="signup-view-right">
          ...
          <div className="text-bottom">
            As a customer I feel like I can never be scammed. ScamTrust make me
            feel really safe when transacting with instagram vendors.
          </div>
