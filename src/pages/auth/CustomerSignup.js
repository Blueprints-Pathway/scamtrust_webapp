...
const CustomerSignup = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full font-secondary">
      {/* Left Grid Content */}
          ...
          <form onSubmit={handleSubmit(customerSignupHandler)}>
            <div className="flex flex-col mb-6">
              ...
              <input
                name="email"
                {...register("email")}
                className="h-[48px] rounded-md px-3 focus:outline-none"
              />
              {errors.email ? (
            ...
            <Button>Proceed to verify BVN</Button>
          </form>
        </div>
      </div>
