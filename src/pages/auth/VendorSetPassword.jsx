			...
			>
				<div className="mb-[5px] mx-[40px]">
					<div className="relative">
						...
						/>
						<p className="py-1 text-gray-400 text-center">
							Minimum of 8 characters with upercase, lowercase and a number.
						</p>
					</div>
					{errors.password ? (
				...
				<div className="my-[30px] mb-[80px] 2xl:mb-[152px] mx-[40px]">
					<Button  forwardIcon={true}>
						Proceed to set a transaction pin
					</Button>
				</div>
			</form>
		</SignupWrapper>
