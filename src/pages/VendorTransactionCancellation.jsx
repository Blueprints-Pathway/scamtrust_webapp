...
const VendorTransactionCancellation = () => {
  return (
    <Layout>
      <img
        src={BackArrow}
      ...
      <form className="w-[1080.5px] font-secondary shadow-md 2xl:w-[1506px] bg-white rounded-[25px] ml-[31.5px] 2xl:ml-[42px] mr-[66.75px] 2xl:mr-[89px] pb-9 mb-[411px] 2xl:mb-[549px] px-[39.75px] 2xl:px-[53px] pt-[37.5px] 2xl:pt-[50px]">
        <h2 className="text-3xl font-semibold text-colorPrimary mb-[37.5px] 2xl:mb-[50px]">
          Choose your cancellation reason
        </h2>

        <input
          className="border border-[#02489F] opacity-60 placeholder:text-xl placeholder:text-colorPrimary px-[53.25px] 2xl:px-[71px] h-12 2xl:h-16 w-full rounded-[5px]"
...
export default VendorTransactionCancellation;
