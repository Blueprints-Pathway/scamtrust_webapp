...
const CustomerCards = () => {
    ...
    const items = [
        {
            id: 1,
            title: "Total volume of new customers",
            total: '535',
        ...
        {
            id: 2,
            title: "Total volume of active customers",
            total: '165',
            arrow: <HiArrowUpRight className='mr-[2px] text-[#32A452] md:text-[10px] xl:text-[13px]' />,
        ...
        {
            id: 3,
            title: "Total volume of inactive customers",
            total: '72',
        ...
        {
            id: 4,
            title: "Total volume of dormant customers",
            total: '20',
            arrow: <HiArrowDownRight className='mr-[2px] text-[#FF0000] md:text-[10px] xl:text-[13px]' />,
