...
function Confirms({ route }) {
	...
	return (
		<div className="container-fluid ">
			...
			<div className="mx-auto box-border  sm:w-full lg:w-5/12   md:6/12  card p-4 border-2 mt-5 pass   left-30 right-30 relative">
						...
						>
							{({
								...
								<form onSubmit={handleSubmit}>
									<div className="form-group">
										...
										<div className="input-group relative">
											...
											<input
												...
												type="password"
												name="password"
												className="text-black mt-5 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
									...
									<label className="block mt-5 text-black">
										Confirm Password
									</label>
									{/* <span className="input-group-text">
									...
									<input
										...
										className="mt-5 text-black px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
									...
									<div className="bottom grid justify-items-center mt-4 mb-5	">
										...
										>
											{!loading ? "loading" : "Updated Password"}
										</button>
									</div>
								</form>
							)}
