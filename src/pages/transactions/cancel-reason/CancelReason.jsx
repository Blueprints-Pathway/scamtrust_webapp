	...
	return (
		<AppLayout>
			<Card className={classes["card-wrapper"]}>
				<div onClick={() => navigate(-1)} className={classes["back-btn-con"]}>
				...
				<div className={classes["content-con"]}>
					<Form onFinish={onFinish}>
						<p className={classes["title"]}>Choose your cancellation reason</p>
			...
			<div className={classes["modal-wrapper"]}>
				<Modal
					className={classes["confirm-modal-con"]}
				...
				>
					<div className={classes["modal-div"]}>
						...
						<div className={classes["modal-btn-con"]}>
							<button onClick={showModal2} className={classes["confirm-btn1"]}>
								Yes
							</button>
							<button
								onClick={handleCancel1}
								className={classes["confirm-btn2"]}
							>
								No
							</button>
						</div>
					...
					>
						<div className={classes["modal-2-con"]}>
							...
							<p className={classes["modal-2-message"]}>
								<span className={classes["trans-id"]}>TR - 7752403</span> was
								cancelled. Reason being, product misrepresentation
							</p>
							<button
								onClick={handleCancel2}
								className={classes["modal-2-btn"]}
							>
								Continue
							</button>
						</div>
