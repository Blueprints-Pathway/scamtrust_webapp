        ...
        <div className={classes['left']}>
            ...
            <div className={classes['content']}>
                ...
                >
                      ...
                      <Form.Item name="First Name" label={<label className={classes['input-label']}>First Name</label>}
                       rules={[
                         {
                           required: true,
                      ...
                      <Form.Item name="Last Name" label={<label className={classes['input-label']}>Last Name</label>}
                       rules={[
                         {
                           required: true,
                      ...
                      <Form.Item name="Phone number" label={<label className={classes['input-label']}>Phone number</label>}
                       rules={[
                         {
                           required: true,
